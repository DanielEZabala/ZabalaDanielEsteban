...
<head>
  ...
  <style>
    ...
    .btn-registro { background: #339904ff; color: white;}
    .btn-visual { background: #f16a6aff; color: white;}
  </style>
</head>
<body>
  <?php if (isset($_GET['msg']) && $_GET['msg'] === 'devolucion_ok'): ?>
  <p style="color: green;">✅ Devolución registrada correctamente.</p>
  <?php endif; ?>

<h2>📘 Panel del Administrador</h2>
<p>Bienvenido, <b><?= htmlspecialchars($_SESSION['admin_user']) ?></b></p>

<a href="Logeout.php" class="btn btn-logout">Cerrar sesión</a>
<a href='../view/formularioLibro.php' class="btn btn-registro">Registrar Libro</a>
<a href='VerLibros.php' class="btn btn-visual">Ver Libros en la base de Datos</a>
<hr>
  ...
  <table>
    ...
    <?php while ($row = $result->fetch_assoc()): ?>
      <tr>
        ...
        <td>
          <form action="Devoluciones_Libro.php" method="POST" style="margin:0;">
